...
// 状态栏: LSP 状态、GSOV 状态、诊断数、光标位置、活动编辑器字数与行数。
...
export function StatusBar() {
  ...
  return (
    <div className="status-bar" title={lspError ?? voiceStatusDetail ?? undefined}>
      ...
      <button
        type="button"
        className={`lsp-status voice-${voiceStatus} voice-status-button`}
        title={voiceStatusDetail ?? '打开配音总控台'}
        onClick={() => setVoiceConsoleOpen(true)}
      >
        GSOV:{' '}
        {voiceStatus === 'ready'
          ? '就绪'
