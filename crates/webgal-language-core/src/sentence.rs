...
mod tests {
    ...
    #[test]
    fn sentence_output_valid_has_no_error() {
        let output = Sentence::from_str("changeBg:bg.png -next;");
        assert!(output.errors.is_empty());
        assert!(!output.has_error());
    }

    #[test]
    fn sentence_output_valid_ok_returns_sentence() {
        let output = Sentence::from_str("changeBg:bg.png -next;");
        assert!(output.ok().is_ok());
    }

    #[test]
    fn sentence_output_invalid_has_error() {
    ...
    #[test]
    fn sentence_output_invalid_ok_returns_errors() {
        let output = Sentence::from_str("changeBg:bg.png -unknownArg;");
